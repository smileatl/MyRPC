...
class GetFriendListsReponse PROTOBUF_FINAL :
 ...
 public:
  ...
  inline GetFriendListsReponse* New() const final {
    return CreateMaybeMessage<GetFriendListsReponse>(nullptr);
  }

  GetFriendListsReponse* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
