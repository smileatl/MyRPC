...
class GetFriendListsReponseDefaultTypeInternal {
 public:
  ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<GetFriendListsReponse> _instance;
} _GetFriendListsReponse_default_instance_;
}  // namespace fixbug
static void InitDefaultsscc_info_GetFriendListsReponse_test_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;

  {
    void* ptr = &::fixbug::_GetFriendListsReponse_default_instance_;
    new (ptr) ::fixbug::GetFriendListsReponse();
    ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyMessage(ptr);
  }
  ::fixbug::GetFriendListsReponse::InitAsDefaultInstance();
}

::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<2> scc_info_GetFriendListsReponse_test_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 2, 0, InitDefaultsscc_info_GetFriendListsReponse_test_2eproto}, {
...
static void InitDefaultsscc_info_LoginReponse_test_2eproto() {
  ...
  ::fixbug::LoginReponse::InitAsDefaultInstance();
}
...
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 35, -1, sizeof(::fixbug::GetFriendListsReponse)},
};
...
static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  ...
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::fixbug::_GetFriendListsReponse_default_instance_),
};
...
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_test_2eproto_sccs[6] = {
  &scc_info_GetFriendListsReponse_test_2eproto.base,
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_test_2eproto = {
  false, false, descriptor_table_protodef_test_2eproto, "test.proto", 574,
...
void LoginReponse::InitAsDefaultInstance() {
  ::fixbug::_LoginReponse_default_instance_._instance.get_mutable()->result_ = const_cast< ::fixbug::ResultCode*>(
...
void GetFriendListsReponse::InitAsDefaultInstance() {
  ::fixbug::_GetFriendListsReponse_default_instance_._instance.get_mutable()->result_ = const_cast< ::fixbug::ResultCode*>(
      ::fixbug::ResultCode::internal_default_instance());
}
...
void GetFriendListsReponse::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_GetFriendListsReponse_test_2eproto.base);
  result_ = nullptr;
}
...
void GetFriendListsReponse::SharedDtor() {
  GOOGLE_DCHECK(GetArena() == nullptr);
  if (this != internal_default_instance()) delete result_;
}

void GetFriendListsReponse::ArenaDtor(void* object) {
  GetFriendListsReponse* _this = reinterpret_cast< GetFriendListsReponse* >(object);
  (void)_this;
}
void GetFriendListsReponse::RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena*) {
}
void GetFriendListsReponse::SetCachedSize(int size) const {
  _cached_size_.Set(size);
}
const GetFriendListsReponse& GetFriendListsReponse::default_instance() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&::scc_info_GetFriendListsReponse_test_2eproto.base);
  return *internal_default_instance();
}
...
const char* GetFriendListsReponse::_InternalParse(const char* ptr, ::PROTOBUF_NAMESPACE_ID::internal::ParseContext* ctx) {
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  ::PROTOBUF_NAMESPACE_ID::Arena* arena = GetArena(); (void)arena;
  while (!ctx->Done(&ptr)) {
    ::PROTOBUF_NAMESPACE_ID::uint32 tag;
...
::PROTOBUF_NAMESPACE_ID::uint8* GetFriendListsReponse::_InternalSerialize(
    ::PROTOBUF_NAMESPACE_ID::uint8* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
...
void GetFriendListsReponse::MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_merge_from_start:fixbug.GetFriendListsReponse)
  GOOGLE_DCHECK_NE(&from, this);
  const GetFriendListsReponse* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<GetFriendListsReponse>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:fixbug.GetFriendListsReponse)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:fixbug.GetFriendListsReponse)
    MergeFrom(*source);
  }
}
...
void GetFriendListsReponse::CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_copy_from_start:fixbug.GetFriendListsReponse)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
template<> PROTOBUF_NOINLINE ::fixbug::GetFriendListsReponse* Arena::CreateMaybeMessage< ::fixbug::GetFriendListsReponse >(Arena* arena) {
